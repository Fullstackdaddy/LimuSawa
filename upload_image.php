...
//this script allows users to upload image to server
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['upload'])) {
        ...
        $allowed = ['image/pjpeg', 'image/jpeg', 'image/JPG', 'image/X-PNG',
...
<form enctype="multipart/form-data" action="upload_image.php" method="post">
    ...
    <fieldset><legend>Select a JPEG or PNG image of 1MB or smaller to be uploaded:</legend>
